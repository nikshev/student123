...
Ролі визначені в `.opencode/agents/*.md`. Делегуй роботу цим субагентам через
`task` для відповідної фази. Агентів, які змінюють файли, запускай послідовно;
...
| звичайна задача `T-xxx` | `implementer` | openrouter/union-alpha |
