...
def build_tutor_prompt(question: str, segments: list[dict[str, Any]], config: dict[str, Any]) -> str:
    """Build the tutor generation prompt from question + retrieved segments."""
