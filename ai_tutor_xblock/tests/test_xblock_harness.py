...
class TestHarness:
    ...
    def test_fixtures_service_dir_exists(self):
        """Каталог фікстур для service HTTP має існувати."""
        assert FIXTURES_SERVICE_DIR.is_dir(), (
            f"Каталог фікстур {FIXTURES_SERVICE_DIR} відсутній; "
            f"створить T-006"
        )