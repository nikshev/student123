...
Вимог: **16** · задач: **39** (виконано 22) · вимог у роботі: **11** · порушень: **0**
...
| `FR-001-16` | Вчитель MUST мати змогу видалити або замінити відео в юніті; це не повинно впливати на події перегляду інших ю | `T-022`, `T-023` | — | `video_xblock/video_xblock/tests/unit/test_delete_video.py` |
