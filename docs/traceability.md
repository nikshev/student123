...
Вимог: **16** · задач: **39** (виконано 20) · вимог у роботі: **12** · порушень: **0**
...
| `FR-001-06` | Відео MUST зберігатися поза сервером платформи; на сервері лишаються лише метадані та посилання. | `T-020`, `T-021` | — | `video_xblock/video_xblock/tests/unit/test_bunny_metadata.py` |
...
| `FR-001-09` | Посилання на захищене відео MUST бути підписане токеном з обмеженим терміном дії; після спливу терміну доступ  | `T-004`, `T-005`, `T-006`, `T-007`, `T-012`, `T-013`, `T-024`, `T-025` | `video_xblock/video_xblock/bunny_config.yaml`, `video_xblock/video_xblock/bunny_config.py`, `video_xblock/video_xblock/backends/bunny.py` | `video_xblock/video_xblock/tests/unit/test_bunny_config.py`, `video_xblock/video_xblock/tests/unit/test_upload_credentials.py`, `video_xblock/video_xblock/tests/unit/test_bunny_api_client.py`, `video_xblock/video_xblock/tests/unit/test_bunny_api_client_signing.py` |
