...
Вимог: **30** · задач: **39** (виконано 38) · вимог у роботі: **15** · порушень: **0**
...
| Вимога | Опис | Задачі | Імплементація | Тести |
|---|---|---|---|---|
| `FR-002-01` | Учень, зарахований на курс, MUST мати змогу поставити питання репетитору в інтерфейсі юніту і отримати відпові | — | — | — |
| `FR-002-02` | Учень, не зарахований на курс, MUST NOT мати доступу до репетитора. | — | — | — |
| `FR-002-03` | Відповідь репетитора MUST спиратися на матеріали поточного юніту (транскрипт лекції, конспект); де можливо, ві | — | — | — |
...
| `FR-002-08` | Після блокування учень MUST бачити зрозуміле пояснення правила («допомагаю розібратися, а не розв'язую за тебе | — | — | — |
| `FR-002-09` | Кожен запит до репетитора MUST фіксуватися в подіях як первинний запис: учень, курс, юніт, час, тема питання — | — | — | — |
| `FR-002-10` | Відповідь MUST надходити протягом 30 секунд у звичайних умовах; якщо сервіс тимчасово недоступний, учень MUST  | — | — | — |
| `FR-002-11` | Кількість запитів на учня MUST бути обмежена добовим лімітом; при досягненні ліміту учень MUST бачити поясненн | — | — | — |
| `FR-002-12` | Учень MUST бачити історію свого діалогу з репетитором у межах юніту. | — | — | — |
| `FR-002-13` | Перед допуском репетитора до живих учнів MUST прогонятися контрольна вибірка завдань: частка відповідей із гот | — | — | — |
| `FR-002-14` | Історія діалогів MUST зберігати мінімум даних, потрібних для метрик і гейт-перевірок; доступ до неї MUST мати  | — | — | — |
