...
Вимог: **16** · задач: **39** (виконано 10) · вимог у роботі: **16** · порушень: **0**
...
| `FR-001-04` | Система MUST відхиляти файли понад встановлений ліміт розміру до початку передавання з поясненням ліміту. | `T-004`, `T-005`, `T-010`, `T-011`, `T-018`, `T-019` | `video_xblock/video_xblock/bunny_config.yaml`, `video_xblock/video_xblock/bunny_config.py` | `video_xblock/video_xblock/tests/unit/test_bunny_config.py`, `video_xblock/video_xblock/tests/unit/test_upload_limits.py` |
