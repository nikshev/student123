...
Вимог: **30** · задач: **93** (виконано 44) · вимог у роботі: **15** · порушень: **0**
...
| `FR-002-11` | Кількість запитів на учня MUST бути обмежена добовим лімітом; при досягненні ліміту учень MUST бачити поясненн | `T-007`, `T-008`, `T-021`, `T-022` | — | — |
