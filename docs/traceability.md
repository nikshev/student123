...
Вимог: **30** · задач: **93** (виконано 67) · вимог у роботі: **12** · порушень: **0**
...
| `FR-002-03` | Відповідь репетитора MUST спиратися на матеріали поточного юніту (транскрипт лекції, конспект); де можливо, ві | `T-017`, `T-018`, `T-029`, `T-030`, `T-031`, `T-032` | `ai_tutor_xblock/ai_tutor_xblock/block.py`, `ai_tutor_service/api/views.py`, `ai_tutor_service/materials/retriever.py`, `ai_tutor_service/materials/repository.py` | `ai_tutor_xblock/tests/unit/test_studio_view.py`, `ai_tutor_service/tests/integration/test_materials_api.py`, `ai_tutor_service/tests/unit/test_fts_retriever.py` |
