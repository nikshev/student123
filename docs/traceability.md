...
Вимог: **30** · задач: **93** (виконано 62) · вимог у роботі: **14** · порушень: **0**
...
| `FR-002-10` | Відповідь MUST надходити протягом 30 секунд у звичайних умовах; якщо сервіс тимчасово недоступний, учень MUST  | `T-003`, `T-004`, `T-011`, `T-012`, `T-013`, `T-014`, `T-025`, `T-026` | `tutor-plugin/plugin.yml`, `ai_tutor_xblock/ai_tutor_xblock/client.py`, `ai_tutor_xblock/ai_tutor_xblock/__init__.py`, `ai_tutor_service/providers/client.py`, `ai_tutor_service/providers/__init__.py` | `ai_tutor_xblock/tests/contract/test_tutor_service_client.py`, `ai_tutor_xblock/tests/contract/test_handlers.py`, `tests/architecture/test_ai_tutor_tutor_plugin.py`, `ai_tutor_service/tests/contract/test_llm_client.py` |
