...
Вимог: **30** · задач: **93** (виконано 55) · вимог у роботі: **15** · порушень: **0**
...
| `FR-002-02` | Учень, не зарахований на курс, MUST NOT мати доступу до репетитора. | `T-015`, `T-016`, `T-023`, `T-024` | `ai_tutor_service/api/apps.py`, `ai_tutor_service/api/urls.py`, `ai_tutor_service/api/errors.py`, `ai_tutor_service/api/auth.py`, `ai_tutor_service/api/__init__.py`, `ai_tutor_service/api/views.py` | `ai_tutor_service/tests/contract/test_api_auth.py` |
| `FR-002-03` | Відповідь репетитора MUST спиратися на матеріали поточного юніту (транскрипт лекції, конспект); де можливо, ві | `T-017`, `T-018`, `T-029`, `T-030`, `T-031`, `T-032` | — | `ai_tutor_service/tests/integration/test_materials_api.py`, `ai_tutor_service/tests/unit/test_fts_retriever.py` |
