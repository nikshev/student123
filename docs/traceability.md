...
| `FR-001-09` | Посилання на захищене відео MUST бути підписане токеном з обмеженим терміном дії; після спливу терміну доступ  | `T-004`, `T-005`, `T-006`, `T-007`, `T-012`, `T-013`, `T-024`, `T-025` | `video_xblock/video_xblock/bunny_config.yaml`, `video_xblock/video_xblock/bunny_config.py` | `video_xblock/video_xblock/tests/unit/test_bunny_config.py` |
