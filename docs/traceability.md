...
Вимог: **30** · задач: **93** (виконано 70) · вимог у роботі: **11** · порушень: **0**
...
| `FR-002-04` | Якщо в матеріалах юніту немає відповіді, репетитор MUST чесно повідомити про це, а не вигадувати відповідь. | `T-033`, `T-034` | — | `ai_tutor_service/tests/unit/test_relevance_policy.py` |
