...
Вимог: **16** · задач: **39** (виконано 25) · вимог у роботі: **9** · порушень: **0**
...
| `FR-001-07` | Учень, зарахований на курс, MUST мати змогу відтворити відео в плеєрі юніту без переходу на сторонні сайти. | `T-003`, `T-026`, `T-027` | `tutor-plugin/plugin.yml` | `video_xblock/video_xblock/tests/unit/test_student_view.py` |
