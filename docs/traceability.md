...
Вимог: **30** · задач: **93** (виконано 80) · вимог у роботі: **6** · порушень: **0**
...
| `FR-002-13` | Перед допуском репетитора до живих учнів MUST прогонятися контрольна вибірка завдань: частка відповідей із гот | `T-043`, `T-044`, `T-053`, `T-054` | `tests/architecture/test_gate_release_lock.py`, `ai_tutor_service/tests/contract/test_gate_api.py` | `tests/architecture/test_gate_release_lock.py`, `ai_tutor_service/tests/contract/test_gate_api.py`, `ai_tutor_service/tests/unit/test_gate_evaluator.py` |
